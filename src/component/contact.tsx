...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-br from-slate-900 via-gray-900 to-amber-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-4 mb-16">
          <h2 className="text-4xl md:text-5xl font-bold">Get In Touch</h2>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Ready to experience premium automotive care? Contact Flash Car today!
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {contactInfo.map((contact, index) => (
            <div key={index} className="text-center space-y-4 group">
              ...
              <p className="text-amber-400 font-semibold">{contact.primary}</p>
              <p className="text-sm text-gray-400">{contact.secondary}</p>
            </div>
          ))}
        </div>
