    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <div>
                <span className="font-bold text-xl">Flash Car</span>
                <div className="text-xs text-gray-400">Riyadh Sky</div>
              </div>
            </div>
            <p className="text-gray-400 text-sm">
              Premium automotive care with 30+ years of excellence across Qatar, Dubai, and Dammam.
            </p>
          </div>
          
          <div className="space-y-4">
            <h4 className="font-bold text-lg text-amber-400">Quick Links</h4>
          ...
          <div className="space-y-4">
            <h4 className="font-bold text-lg text-amber-400">Our Services</h4>
          ...
          <div className="space-y-4">
            <h4 className="font-bold text-lg text-amber-400">Locations</h4>
            <div className="space-y-2 text-sm">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2025 Flash Car - Riyadh Sky. All rights reserved.</p>
        </div>
      </div>
    </footer>
    )
