                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="space-y-8">
                            ...
                            <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
                                <p>
                                    <strong>Flash Car</strong>, under the
                                    umbrella of{" "}
                        ...
                        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                            <div className="space-y-6">
                                ...
                                <p className="text-gray-700 text-lg leading-relaxed">
                                    ...
                                    transform automotive care through unwavering
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-white/10 rounded-xl p-6 backdrop-blur-sm border border-white/20">
                                        <h4 className="text-2xl font-bold mb-4">
                                            To establish 100 branches worldwide
                                        </h4>
                                        <p className="text-amber-100 leading-relaxed">
                                            Making Flash Car a global leader in
                                            automotive care, bringing our three
                                            decades of expertise to customers
                                            across the world.
                                        </p>
                                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-300">
                            Three strategic locations serving the Middle East
                        </p>
                    </div>
